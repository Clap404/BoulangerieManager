...
composition d'une nouvelle vente, à l'exception de la liste de selection
d'une adresse de livraison et du selecteur de la date de livraison.
...
\paragraph{}
Selectionnez ensuite la date convenue pour la livraison de la commande.
...
\paragraph{}
Dans le cas ou vous passez une commande pour un nouveau client ou pour un client
existant à une nouvelle adresse, vous devez d'abord ajouter un client ou ajouter
un adresse comme décrit dans le chapitre "Clients".
...
Si vous souhaitez anuller une commande en cours, cliquez sur le bouton
"Modifier" et, une fois sur l'écran de composition de commande, videz simplement
la commande grâce au bouton "RAZ" avant de valider.